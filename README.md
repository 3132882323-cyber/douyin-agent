...
> 当前版本：`v3.5.0 Beta`。经营工作台收敛为“货架商品、直播投放、内容”三条业务链路，取消总管视图；投放仍保持策略预演、人工授权、受控执行和页面回读验收。
...
| --- | --- | --- |
| 货架商品 | 商品承接和库存是否支持继续获取流量 | 货架漏斗、商品卡诊断、库存与补货动作 |
| 直播投放 | 直播流量为什么没有转化、哪些计划需要止损 | 直播漏斗、计划级建议、授权执行和验收 |
| 内容 | 哪些素材应停测、复用或补测 | 视频表现、脚本钩子和内容测试清单 |
