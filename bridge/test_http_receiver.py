...
class SnapshotStoreTests(unittest.TestCase):
    ...
    def test_supervised_preflight_requires_new_readback_and_can_be_stopped(self) -> None:
        ...
        draft = http_receiver.build_action_draft(
            ...
            promotion_context={"promotion_mode": "standard", "account_scope": {"store_id": "store-1", "account_id": "acct_preflight1"}, "strategy_id": "plan_preflight1", "metric_contract": {"definition": "pay_roi", "version": "v1"}},
            target_name="止损检查计划",
    ...
    def test_cancelled_action_invalidates_existing_execution_authorization(self) -> None:
        ...
        draft = http_receiver.build_action_draft(
            ...
            promotion_context={"promotion_mode": "standard", "account_scope": {"store_id": "store-1", "account_id": "acct_cancel001"}, "strategy_id": "plan_cancel001", "metric_contract": {"definition": "pay_roi", "version": "v1"}},
            target_name="撤销授权计划",
    ...
    def test_supervised_preflight_rejects_budget_increase(self) -> None:
        ...
        draft = http_receiver.build_action_draft(
            ...
            promotion_context={"promotion_mode": "standard", "account_scope": {"store_id": "store-1", "account_id": "acct_scale001"}, "strategy_id": "plan_scale001", "metric_contract": {"definition": "pay_roi", "version": "v1"}},
            target_name="放量计划",
